...
const EditePageCustomer = ({customer}) => {
    ...
    const EditeHandler = () => {
        ...
        axios.post("/api/customers/edite" , formData)
        .then(res => {
    ...
    return (
        ...
        <>
            ...
            <div className={styles.titlePage}>Edite Customer</div>
            ...
            <div>
                ...
                <div className={styles.btns}>
                    ...
                    <button className="buttons button2" onClick={EditeHandler}>Edite</button>
...
export default EditePageCustomer;